...
int registar_aluno(Aluno meus_alunos[],int posicao){
	
	
	if(posicao<ALUNOS){
		printf("\nIndique o nome do aluno:");
	    scanf("%s",&meus_alunos[posicao].nome); 
	    printf("\nIndique o ano de nascimento:");
	    scanf("%d",&meus_alunos[posicao].ano_nasc);  
	    printf("\nIndique a media do aluno:");
	    scanf("%f",&meus_alunos[posicao].media);
	   
	    printf("\nO aluno %s esta registado sob numero %d", meus_alunos[posicao].nome,posicao); 
	    printf("\n");
	    posicao++;
...
void listar_alunos(Aluno meus_alunos[],int posicao){
	int i;
    for(i=0;i<posicao;i++){	
        printf("\n");
...
void media_superior(Aluno meus_alunos[],int posicao){
	int i;
	int k=0;
	for(i=0;i<posicao;i++){
...
void nome_comeca_que_letra(Aluno meus_alunos[],int posicao){
	int i;
	int k=0;
	for(i=0;i<posicao;i++){
...
int verificar_se_aluno_existe(Aluno meus_alunos[],int posicao){
   int i;
   int k=0;
   char input_nome[20];
   printf("\nIndique o nome do aluno:");
   scanf("%s", input_nome); 
       ...
       if(k==0){
       registar_aluno(meus_alunos,posicao);
	}
}
...
meus_alunos[2].media=18;
	...
	switch(opcao){
      case 1: 
      ultimo_aluno=registar_aluno(meus_alunos,ultimo_aluno);
       
       
       break;
       
      case 2:
       listar_alunos(meus_alunos,ultimo_aluno);
       break;
       
      case 3:
       media_superior(meus_alunos,ultimo_aluno);	
       break;
       
      case 4:
       nome_comeca_que_letra(meus_alunos,ultimo_aluno);
       break;
       
      case 5:
       verificar_se_aluno_existe(meus_alunos,ultimo_aluno);
	   break;
